...
<div className="row primary">
  ...
  <h2 className='footertitle'>\Binge Blog\</h2>
...
<div className="column links">
  <h3 className="h31" > External Links</h3>
   <ul>
...
<h2 className='footertitle'>Disclaimer</h2>
<p className='p1'>This is a personal blog. All content provided (Especially Blog Articles) on this blog is for Academic purpose. The owner of this blog makes no representation as to the accuracy of complete was of any information on this site or found by following any link on this information. The owner will not liable for any losses or damages from the display or use of this information. 
 </p>
 <h5 className='h31' >Sree Sankar</h5>
</div>
